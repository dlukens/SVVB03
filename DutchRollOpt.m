...
for idx2 = -1:0.9/length2:-0.1
   ...
   % variance1 = (dot(error1,error1))/length(y_sym(:,1));
    variance1 = 0;
    error2 = ((y_sym(:,2))-flightdata.Ahrs1_Roll.data(start:finish,1)*pi/180)/(max(flightdata.Ahrs1_Roll.data(start:finish,1)*pi/180)-min(flightdata.Ahrs1_Roll.data(start:finish,1)*pi/180));
    ...
    error3 = ((y_sym(:,3))-flightdata.Ahrs1_bRollRate.data(start:finish,1)*pi/180)/(max(flightdata.Ahrs1_bRollRate.data(start:finish,1)*pi/180)-min(flightdata.Ahrs1_bRollRate.data(start:finish,1)*pi/180));
    ...
    error4 = ((y_sym(:,4))-flightdata.Ahrs1_bYawRate.data(start:finish,1)*pi/180)/(max(flightdata.Ahrs1_bYawRate.data(start:finish,1)*pi/180)-min(flightdata.Ahrs1_bYawRate.data(start:finish,1)*pi/180));
